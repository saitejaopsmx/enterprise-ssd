...
- ```kubectl -n try-ssd apply -f [https://raw.githubusercontent.com/ksrinimba/enterprise-ssd/main/try-ssd.yaml](https://raw.githubusercontent.com/OpsMx/enterprise-ssd/chartv1/try-ssd.yaml)```
